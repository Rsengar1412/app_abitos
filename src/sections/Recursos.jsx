...
const GENERAL_RESOURCES = [
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          La adicción secuestra tu sistema de dopamina. No eres tú deseándolo realmente, es tu
          cerebro pidiendo una dosis rápida.
        </p>
        <p>
          Cuando sientas urgencia, di: "Esto es solo una señal química falsa, yo tengo el control".
        </p>
      </>
    ),
  },
  ...
  porn: [
    {
      ...
      content: (
        <>
          <p>
            Hazlo difícil. Instala bloqueadores DNS o aplicaciones que filtren contenido adulto en
            tus dispositivos.
          </p>
  ...
  smoking: [
    {
      ...
      content: (
        <>
          <p>
            El deseo de fumar dura entre 3 y 5 minutos. Si superas ese pico, la ansiedad bajará.
          </p>
  ...
  socialmedia: [
    {
      ...
      content: (
        <>
          <p>
            Configura tu móvil en escala de grises. Esto lo hace mucho menos adictivo visualmente.
          </p>
  ...
  sugar: [
    {
      ...
      content: (
        <>
          <p>
            El azúcar genera un pico seguido de un bajón que te pide más azúcar. Rompe el ciclo con
  ...
  alcohol: [
    {
      ...
      content: (
        <>
          <p>
            En eventos sociales, pide agua con gas y limón o una bebida sin azúcar. Mantener algo en
            la mano reduce la presión social.
          </p>
  ...
  caffeine: [
    {
      ...
      content: (
        <>
          <p>
            La cafeína bloquea los receptores de adenosina que te indican que estás cansado.
            Sustitúyela por infusiones o agua fría al despertar.
          </p>
        </>
      ),
    },
  ...
  gaming: [
    {
      ...
      content: (
        <>
          <p>
            Usa la técnica de gamificación en tu vida real: asigna puntos a tus tareas diarias y
            'sube de nivel' con tus objetivos personales.
          </p>
        </>
      ),
    },
  ...
  gambling: [
    {
      ...
      content: (
        <>
          <p>
            Elimina tus datos de pago de sitios de apuestas y limita tus transferencias diarias. El
            tiempo es tu activo más valioso.
          </p>
        </>
      ),
    },
      ...
      <div className="grid gap-4">
        {resources.map((item, idx) => (
          <div
            ...
            className="bg-bg-primary/50 rounded-md overflow-hidden transition-all duration-300"
          >
            <button
              type="button"
