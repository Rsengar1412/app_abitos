...
const CONSEJOS_HABITOS = {
  ...
  sugar: [
    'Come una pieza de fruta o bebe agua.',
  ...
  caffeine: [
    'Tu cuerpo sabe generar energía por sí solo.',
    'Bebe agua fría o una infusión sin cafeína.',
  ],
...
const POOL_ACCIONES = [
  {
    ...
    title: '20 Flexiones',
    desc: 'Al fallo. Quema esa energía.',
    color: '#e67e22',
  },
  {
    icon: <Zap size={32} />,
    title: 'Sprints',
    desc: 'Corre en el sitio 1 min a tope.',
    color: '#f1c40f',
  },
  {
    icon: <Droplets size={32} />,
    title: 'Agua Fría',
    desc: 'Mójate la cara o dúchate.',
    color: '#3498db',
  },
  {
    icon: <Wind size={32} />,
    title: 'Respiración Vim Hof',
    desc: '30 inhalaciones profundas.',
    color: '#1abc9c',
  },
  {
    icon: <Footprints size={32} />,
    title: 'Sal a Caminar',
    desc: 'Sin rumbo. 10 minutos.',
    color: '#2ecc71',
  },
  {
    icon: <Phone size={32} />,
    title: 'Llama a un Amigo',
    desc: 'Habla con alguien real.',
    color: '#9b59b6',
  },
  {
    icon: <Music size={32} />,
    title: 'Música Épica',
    desc: 'Ponte tu canción favorita.',
    color: '#e74c3c',
  },
  {
    icon: <BookOpen size={32} />,
    title: 'Lee 2 Páginas',
    desc: 'Cualquier libro físico.',
    color: '#bdc3c7',
  },
  {
    icon: <PenTool size={32} />,
    title: 'Diario',
    desc: 'Escribe cómo te sientes.',
    color: '#8e44ad',
  },
  {
    icon: <ShieldAlert size={32} />,
    title: 'Modo Avión',
    desc: 'Desconecta 15 minutos.',
    color: '#c0392b',
  },
];
      ...
      <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center p-8 text-white overflow-y-auto bg-gradient-to-br from-[#1a2a6c] via-[#b21f1f] to-[#fdbb2d] animate-gradient">
        ...
        {!showActions ? (
          <>
            ...
            <h2 className="mb-4 text-3xl font-light tracking-widest text-white drop-shadow sm:text-2xl">
              Respira
            </h2>
            <p className="text-xl text-center max-w-[320px] leading-relaxed font-semibold mb-12 drop-shadow sm:text-lg">
              "{currentTip}"
            </p>
            <button
              type="button"
          ...
          <>
            ...
            <div className="grid gap-4 w-full max-w-[400px]">
              {randomActions.map((action) => (
                ...
                >
                  <div className="mb-3" style={{ color: action.color }}>
                    {action.icon}
                  </div>
